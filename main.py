...
def navigate(x,y):
     ...
     if game_state == "home_screen":
         if int(x) in range(int(width/2)-200, int(width/2)+200) and int(y) in range(int(height/2)-50,int(height/2)+50):
             ...
             wn.clearscreen()
             showGrid(generateGrid(40))

         if int(x) in range(int(width/2)-200, int(width/2)+200) and int(y) in range(int(height/2)-100,int(height/2)-200):
             game_state = "saved_screen"
             wn.clearscreen()
             savedScreen()

         if int(x) in range(int(width/2)-200, int(width/2)+200) and int(y) in range(int(height/2)-250,int(height/2)-350):
             game_state = "lead_screen"
             wn.clearscreen()
             leadScreen()
